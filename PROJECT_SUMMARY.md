...
| `/review` | `src/app/review/page.tsx` | Quiz session: all plan items loaded (done ones show prompt, user answer, and stored answer; auto-skip); ONE batch AI grade at the end → report card. Flashcard mode replaced by graded True/False statements. |
...
- `src/components/ProgressMap.tsx` — streak Momentum card + 16-week review activity heatmap.
