# Graph Report - Learning  (2026-07-21)

## Corpus Check
- 193 files · ~284,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1170 nodes · 2080 edges · 93 communities (70 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9a158fa`
...
8. `isMissingRag()` - 14 edges
9. `SqlTopic` - 14 edges
10. `getTopics()` - 13 edges
...
Cohesion: 0.14
Nodes (24): DemoSession, demoState, demoEntries, demoFacts, demoGrade(), demoLinks, demoPlan, demoProfile (+16 more)
...
Cohesion: 0.05
Nodes (37): 2026-07-13 — AI-call minimisation redesign: question bank, batch report card, MCQs, fact of the day, 2026-07-13 — Brain label overhaul (clickable, Space Grotesk, declutter), 2026-07-13 — Dashboard/brain polish: rich insight, clickable plan, topic blogs, smaller labels, 2026-07-13 — Fix /profile infinite loading (missing profiles row), 2026-07-13 — Guest mode fix, plan done-tracking, review error card, blog pills, 2026-07-13 — Personal notes feature + blog source attribution, 2026-07-13 — Plan markdown fix, progress calendar, profile page, 2026-07-13 — Rebranding to Engramia + Mastery/XP removal + True/False Statements + Detailed completed reviews (+29 more)

### Community 29 - "Tasks"
Cohesion: 0.07
Nodes (28): ALL 18 CHAPTERS / 150 QUESTIONS COMPLETE — 2026-07-21, Chapter 10 — Tries (`tries.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-20, Chapter 11 — Graphs (`graphs.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-20, Chapter 12 — Advanced Graphs (`advanced-graphs.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-21, Chapter 13 — 1-D Dynamic Programming (`dp-1d.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-21 (also normalized off old ASCII/Python template; hardcoded `questions` arrays preserved), Chapter 14 — 2-D Dynamic Programming (`dp-2d.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-21 (also normalized off old ASCII/Python template; hardcoded `questions` arrays preserved), Chapter 15 — Greedy (`greedy.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-21, Chapter 16 — Intervals (`intervals.ts`) — intro: [D: ✗] — CHAPTER DONE 2026-07-21 (+20 more)
...
Cohesion: 0.15
Nodes (20): StoryLearnPanel(), STORY_COLORS, StoryStartControl(), CompActQuestion, DsaQuestion, MacroQuestion, SarfaesiQuestion, completeSection() (+12 more)

### Community 49 - "page.tsx"
Cohesion: 0.16
Nodes (17): QuizCarousel(), FlameIcon(), dayClasses(), dayKey(), ProgressCalendar(), WEEKDAYS, Heatmap(), nextMilestone() (+9 more)

### Community 50 - "QuestionKind"
Cohesion: 0.15
Nodes (7): metadata, ProfilePage(), LINKS, Nav(), getProfile(), getUserEmail(), signOut()
...
Cohesion: 0.15
Nodes (16): ReviewRunner(), SERIES_COLORS, SERIES_TITLES, api(), finishQuiz(), getLatestReportToday(), getPlan(), ingestLink() (+8 more)
...
Cohesion: 0.36
Nodes (8): sourceLabel(), TopicBlogPage(), getLinks(), getTopic(), getTopicQuestions(), getTopics(), getTopicSource(), createClient()
...
### Community 89 - "New story series: "Talking with Psychopaths and Savages" — Plan + Checklist"
Cohesion: 0.17
...
### Community 90 - "True Crime & Forensic Casework Story Creator Agent"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (3): KIND_LABEL, ReportCard, ReportItem
...
- **Why does `QuestionKind` connect `QuestionKind` to `Review and Scoring System`, `schema.sql`, `index.ts`, `index.ts`, `route.ts`, `stories.ts`?**
