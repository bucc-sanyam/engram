...
## Corpus Check
- 226 files · ~435,576 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1402 nodes · 2588 edges · 99 communities (75 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f3b4ed3`
...
Cohesion: 0.13
Nodes (28): DemoSession, demoState, demoEntries, demoFacts, demoGrade(), demoLinks, demoPlan, demoProfile (+20 more)
...
Cohesion: 0.13
Nodes (26): generateMetadata(), MacroChapterPage(), generateMetadata(), generateStaticParams(), MacroSectionPage(), MacroeconomicsPage(), getMacroChapter(), getMacroSection() (+18 more)

### Community 8 - "BrainScene.tsx"
Cohesion: 0.14
Nodes (26): Prefetcher(), cached(), CacheEntry, CacheOptions, canPersist, clearCache(), getEntry(), INFLIGHT (+18 more)
...
Cohesion: 0.04
Nodes (46): 2026-07-13 — AI-call minimisation redesign: question bank, batch report card, MCQs, fact of the day, 2026-07-13 — Brain label overhaul (clickable, Space Grotesk, declutter), 2026-07-13 — Dashboard/brain polish: rich insight, clickable plan, topic blogs, smaller labels, 2026-07-13 — Fix /profile infinite loading (missing profiles row), 2026-07-13 — Guest mode fix, plan done-tracking, review error card, blog pills, 2026-07-13 — Personal notes feature + blog source attribution, 2026-07-13 — Plan markdown fix, progress calendar, profile page, 2026-07-13 — Rebranding to Engramia + Mastery/XP removal + True/False Statements + Detailed completed reviews (+38 more)
...
Cohesion: 0.24
Nodes (9): commit, deterministicBody(), firstSentenceAndRest(), limitArg, run(), sourceTextForTopic(), supabase, TopicRow (+1 more)
...
Cohesion: 0.11
Nodes (12): metadata, ProfilePage(), FlameIcon(), LINKS, Nav(), Heatmap(), nextMilestone(), ProgressMap() (+4 more)
...
Cohesion: 0.13
Nodes (22): ancestorsInclude(), NoteEditor(), NoteRow(), NotesPage(), Dashboard(), MODE_LABEL, SERIES_META, SERIES_TITLES (+14 more)

### Community 99 - "stories.ts"
Cohesion: 0.13
Nodes (21): StoryLearnPanel(), STORY_COLORS, StoryStartControl(), CACHE_KEYS, CompActQuestion, DsaQuestion, MacroQuestion, PsQuestion (+13 more)

### Community 100 - "Nav.tsx"
Cohesion: 0.13
Nodes (16): QuizCarousel(), dayClasses(), dayKey(), ProgressCalendar(), WEEKDAYS, BigScoreRing(), KIND_LABEL, getDayReport() (+8 more)
...
Cohesion: 0.14
Nodes (21): GroupRunner(), ReviewRunner(), SERIES_COLORS, SERIES_TITLES, trackRecallGraded(), trackStreakAdvanced(), invalidate(), api() (+13 more)

## Knowledge Gaps
- **565 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+560 more)
